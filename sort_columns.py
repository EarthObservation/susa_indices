"""
TOOL: Put columns (DataFrame) into correct order

Not a good code, but a quick fix to sort and rename columns into the correct
order.

The reason why I had to do this was because images were not correctly stacked
(wrong file order) for ndvi and evi2 index. Changed code in stack_gtif to sort
by filename (in our case filename is date, so it is sorted by date).
"""
